-- schema.sql – AI Governance Intelligence Platform (enhanced)

-- 1️⃣ Reference tables (optional ENUMs)
...
-- 3️⃣ View for priority scoring (example formula)
...
-- Index on view removed (SQLite does not support indexing a view)
